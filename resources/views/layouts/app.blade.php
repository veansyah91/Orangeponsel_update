...
<body>
                        ...
                        @else
                            @role('SUPER ADMIN|ADMIN')
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle dropdown-toggle-arrow{{ request()->is('account/*') ? ' active' :'' }}" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
    ...
    <div id="print" class="d-print-block d-none mt-3 mb-2 font-monospace" style="width: 70mm;color:black">
