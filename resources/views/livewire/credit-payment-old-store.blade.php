                    ...
                    <table class="table table-sm table-responsive">
                        ...
                        <tbody>
                            ...
                            @foreach ($creditPayments as $creditPayment)
                                <tr>
                                    <td class="text-center">{{ $creditPayment->nomor_nota }}</td>
                                    <td class="text-center">{{ $creditPayment->tanggal_bayar }}</td>
                                    <td class="text-center">{{ CreditPartner::getBiodataOld($creditPayment->credit_app_old_id)["nama"] }}</td>
                                    <td class="text-center">{{ CreditPartner::getBiodataOld($creditPayment->credit_app_old_id)["no_hp"] }}</td>
