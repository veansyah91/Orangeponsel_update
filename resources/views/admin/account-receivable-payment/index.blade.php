...
<div class="container" id="account-receivable-payment-container" data-outlet-id="{{ $outletUser['outlet_id'] }}" data-outlet-name="{{ $outlet['nama'] }}" data-outlet-address="{{ $outlet['alamat'] }}">
            ...
            <div class="card">
                <div class="card-header h3">
                    <div class="row">
                        <div class="col-12 col-md-6" >
                            Pembayaran Piutang <span id="count-data" style="color: gray;font-size:20px;margin-left:10px"></span>
                        </div>
                        <div class="col-12 col-md-6 text-md-right text-center mt-2 mt-md-0">
                            <div class="row">
                                <div class="col-12 col-md-9">
                                    <form onsubmit="submitSearchAccountReceivablePayment(event)">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Cari..." aria-label="Cari..." 
                                            id="search-account-receivable">
                                ...
                                <div class="col-12 col-md-3 mt-2 mt-md-0 text-right">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#createAccountReceivablePaymentModal"
                ...
                <div class="card-body table-responsive" style="height: 450px" >
                    <table class="table table-sm">
                        ...
                        <tbody id="account-receivable-payment-list-table">
...
<div class="modal fade" id="createAccountReceivablePaymentModal" tabindex="-1" aria-labelledby="createAccountReceivablePaymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="createAccountReceivablePaymentModalLabel">Rincian Piutang</h4>
                ...
                <div class="row mt-2 border-top">
                    ...
                    <div class="col-12 table-responsive">
                        <table class="table table-sm">
                            ...
                            <tbody id="account-receivable-detail-list-table">
...
@push('scripts')
    <script src="{{ asset('js/account-receivable-payment/index.js') }}">
    </script>
